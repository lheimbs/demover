...
# ZSH_THEME_RANDOM_CANDIDATES=( "mh" "miloshadzic" "geoffgarside" "crunch" )
...
alias polybar-cfg="vim ~/.config/polybar/config"
alias i3-cfg="vim ~/.i3/config"
alias xres-cfg="vim ~/.Xresources"
alias ohm-vpn="startct -m console"
